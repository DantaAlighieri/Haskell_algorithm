...
/* package minihs-1.0.0 */
#ifndef VERSION_minihs
#define VERSION_minihs "1.0.0"
#endif /* VERSION_minihs */
#ifndef MIN_VERSION_minihs
#define MIN_VERSION_minihs(major1,major2,minor) (\
  (major1) <  1 || \
  (major1) == 1 && (major2) <  0 || \
  (major1) == 1 && (major2) == 0 && (minor) <= 0)
#endif /* MIN_VERSION_minihs */
...
#define CURRENT_COMPONENT_ID "minihs-1.0.0-inplace-minihs"
